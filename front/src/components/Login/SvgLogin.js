...
const SvgLogin = () => {
    ...
    const bounce = keyframes`
        from, 20%, 53%, 80%, to {
            ...
            fill:${cssVariables.colors().bgPrimaryLight};
        }
...
`
    const bounceCircle = keyframes`
        ...
        25%{
            fill:${cssVariables.colors(0.6).bgPrimary};
        }

        50% {
            fill:${cssVariables.colors(0.6).bgSecondary};
        }

        75% {
            fill:${cssVariables.colors().bgSecondary};
        }
`
    return (
        <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="80%" height="80%" viewBox="0 0 744.84799 747.07702">
            <path id="fa3b9e12-7275-481e-bee9-64fd9595a50d"
                ...
                transform="translate(-227.576 -76.46149)" fill={cssVariables.colors().bgMain} />
            ...
            <path id="b3ac2088-de9b-4f7f-bc99-0ed9705c1a9d"
                ...
                fill={cssVariables.colors().bgPrimaryLight} className={
                    css(load && {
            ...
            <path id="b06d66ec-6c84-45dd-8c27-1263a6253192"
                ...
                transform="translate(-227.576 -76.46149)" fill={cssVariables.colors().bgPrimaryLight}
                className={
                    css(load && {
            ...
            <path id="e73810fe-4cf4-40cc-8c7c-ca544ce30bd4" data-name="Path 7"
                ...
                transform="translate(-227.576 -76.46149)" fill={cssVariables.colors().bgPrimaryLight} className={
                    css(load && {
                        animation: `${bounce} 1s ease infinite`,
                        transformOrigin: `center bottom`,
            ...
            <circle id="a4813fcf-056e-4514-bb8b-e6506f49341f" data-name="Ellipse 1"
                cx="364.43401" cy="261.50202" r="24.45" fill={cssVariables.colors().bgPrimaryLight} className={
                    css(load && {
                        animation: `${bounceCircle} 1s ease infinite`,
                        transformOrigin: `center bottom`,
                        animationDelay: `0.3333s`
            ...
            <circle id="fcef55fc-4968-45b2-93bb-1a1080c85fc7" data-name="Ellipse 2"
                cx="225.46401" cy="427.41999" r="6.902" fill={cssVariables.colors().bgPrimaryLight} />
            ...
            <circle id="e8fa0310-b872-4adf-aedd-0c6eda09f3b8" data-name="Ellipse 3" cx="225.46401" cy="496.43702"
                r="6.902" fill={cssVariables.colors().bgPrimaryLight} />
            ...
            <circle id="e12ee00d-aa4a-4413-a013-11d20b7f97f7"
                data-name="Ellipse 7" cx="247.97799" cy="427.41999" r="6.902"
                fill={cssVariables.colors().bgPrimaryLight} />
            <circle id="f58f497e-6949-45c8-be5f-eee2aa0f6586"
                data-name="Ellipse 8" cx="270.492" cy="427.41999" r="6.902"
                fill={cssVariables.colors().bgSecondary} />
            <circle id="b4d4939a-c6e6-4f4d-ba6c-e8b05485017d"
                data-name="Ellipse 9" cx="247.97799" cy="496.43702" r="6.902"
                fill={cssVariables.colors().bgSecondary} />
            <circle id="aff120b1-519b-4e96-ac87-836aa55663de"
                data-name="Ellipse 10" cx="270.492" cy="496.43702" r="6.902"
                fill={cssVariables.colors().bgSecondary} />
            ...
            <path id="ae7af94f-88d7-4204-9f07-e3651de85c05" data-name="Path 99"
                ...
                transform="translate(-227.576 -76.46149)" fill={cssVariables.colors().bgSecondary} />
