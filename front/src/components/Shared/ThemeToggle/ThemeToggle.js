...
const ThemeToggle = ({ inNav }) => {
    ...
    useEffect(() => {
        ...
        themeInput.current.checked = (theme === 'dark') ? true : false;
    }, [theme])
    // useEffect(() => {
    //     themeInput.current.checked = (theme === 'dark') ? false : true;
    // }, [theme])
    return (
        <MuiIconBtn
        ...
        >
            <label className="swap swap-rotate">
                ...
                />
                <svg className={css([
                    tw`swap-on fill-current w-6 h-6 sm:w-8 sm:h-8 text-secondary`,
                ])}
                ...
                <svg className={css([
                    ...
                    inNav && theme === 'light' ? tw`text-whiteX` : tw`text-primary`
